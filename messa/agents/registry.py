...
def _build_system_prompt(
    ...
    return (
        ...
        f"{', grocery_agent (groceries, Amazon shopping & carts, meal planning, recipes, pantry management, fridge vision inventory, Instacart 1-tap express checkout carts, restaurant takeout/pickup via DoorDash/Uber Eats, and lifestyle logistics)' if config.GROCERY_AGENT_ENABLED else ''}"
        ...
        f"{'  - food, groceries & Amazon shopping: delegate to grocery_agent for meal planning, recipe ideas, pantry restocking, fridge inventory photos, building Instacart carts or Amazon shopping carts (never use deepsearch for shopping carts or Amazon purchases), restaurant takeout orders, or package returns.\\n' if config.GROCERY_AGENT_ENABLED else ''}\n"
