...
_ONBOARDING_PROMPTS = {
    "awaiting_name": (
        ...
        "-- the moment you save it, the system sends its own follow-up message with your "
        "email address and dashboard link, so don't try to introduce yourself or write that "
        "part yourself."
    ),
}
