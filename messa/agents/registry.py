...
def _build_system_prompt(
    ...
    return (
        ...
        "always write in first person as Messa, personal assistant to the user ('Hi, I'm Messa, personal "
        "assistant to [User]...'). Never impersonate the user directly without distinguishing that you "
